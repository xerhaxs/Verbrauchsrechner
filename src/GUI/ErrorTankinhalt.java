...
public class ErrorTankinhalt extends JDialog {
    public JPanel contentPane;
    private JButton buttonOK;
    private JTextField derTankIstLeiderTextField;
    private JButton buttonCancel;

    public ErrorTankinhalt() {
